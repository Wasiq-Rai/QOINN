...
const Contact = () => {
  ...
  return (
    <section className="pt-[2rem] pb-0 bg-white" id="contact">
          <div className="flex container px-4 md:px-6 md:pl-[4rem]">
            ...
            <div className="flex flex-wrap justify-center mb-8 flex-col w-full h-full">
              ...
              <Link href="/invest" className='flex justify-center md:justify-start w-full'>
            ...
            <div className="hidden md:flex flex-wrap justify-end mb-8 w-full">
              <img
