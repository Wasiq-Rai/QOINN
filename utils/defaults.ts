...
export const defaultTheme: ThemeContent = {
  strings: {
    siteName: "QOINN",
    welcomeMessage: "Turn Volatility into Opportunity",
    welcomeMessage2: "Control the Uncontrollable",
    welcomeMessage3: "Where Financial Signals Meet Physics Insights",
    welcomeMessage4: "Let Your Capital Think Smarter",
    welcomeMessage5: "Designed to Anticipate, Engineered to Stabilize, Built to Endure",
    welcomeMessage6: "Stay Coherent through the Chaos",
    welcomeMessage7: "Remain Fault-Tolerant through the Uncertainty",
